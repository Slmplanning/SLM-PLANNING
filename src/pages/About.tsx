              ...
              >
                <div className="relative w-full h-48 overflow-hidden">
                  ...
                  <div className="absolute left-0 bottom-3 w-full flex flex-row gap-3 justify-center items-end opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10">
                    ...
                    <a href="#" className="inline-block" tabIndex={-1}><img src="/Assets/instagram-icon.png" alt="Instagram" className="w-8 h-8 rounded-full bg-white p-1 shadow hover:scale-110 transition-transform duration-200" /></a>
                  </div>
