...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden p-0 m-0 w-screen max-w-none" style={{ marginLeft: '-2rem', marginRight: '-2rem', paddingLeft: 0, paddingRight: 0 }}>
