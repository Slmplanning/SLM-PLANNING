  ...
  return (
    <div className={`relative w-full ${heightClass} flex items-center justify-center`}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-30 text-center px-4">
        <h2 className="text-white text-4xl md:text-6xl font-bold drop-shadow-lg mb-4">3D Rendering</h2>
        <p className="text-white text-lg md:text-2xl font-medium drop-shadow-lg max-w-2xl mx-auto">Photorealistic 3D visualizations for your projects.</p>
      </div>
      {/* Carousel dots */}
